...
# Version : 1.83
# Date    : 10/30/2023
# Description : design a test script for inversioncounter.cpp program
...
run_test_with_args_and_input "slow" "1 2 3 4 5 6 7 8"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
...
run_test_with_args_and_input "slow" "5 5 5 5 5 5 5 5"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "slow" "8 7 6 5 4 3 2 1"   "Enter sequence of integers, each followed by a space: Number of inversions: 28"
run_test_with_args_and_input "slow" "1 7 6 2 3 8 5 4"   "Enter sequence of integers, each followed by a space: Number of inversions: 13"
run_test_with_args_and_input "slow" "-6 5 2 1 8 7 -3 4"   "Enter sequence of integers, each followed by a space: Number of inversions: 14"
run_test_with_args_and_input "slow" "3 2 1 4" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
...
run_test_with_args_and_input "" "1" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "" "1 2 3 4"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
